...
| [AIHub 텍스트 윤리검증 데이터](https://aihub.or.kr/aihubdata/data/view.do?dataSetSn=558) | 비윤리 문장 검증 (비난·혐오·차별·폭력·범죄·성적·욕설 7종) | 453,340 문장 / 132,807 대화세트 | 심심이(주) 외 · NIA | AI Hub 2021 | ❓ (AI Hub 약관) | [AI Hub](https://aihub.or.kr/aihubdata/data/view.do?dataSetSn=558) |
...
| 이름 | 평가 영역 | 사이즈 | 제작자 | 발표 (학회/연도) | 상업적 사용 | 데이터 |
| --- | --- | --- | --- | --- | --- | --- |
| [CAGE / KoRSET](https://arxiv.org/abs/2602.20170) | 문화 적응형 레드티밍 (한국 법·문화 기반) | KoRSET ≈7,161 프롬프트 | SelectStar AI (Kim et al.) | arXiv 2026.02 | ❓ (공개·라이선스 확인 필요) | [arXiv](https://arxiv.org/abs/2602.20170) |
| [영어-한국어 탈옥 프롬프트](https://koreascience.or.kr/article/JAKO202518939602628.page) | 탈옥 프롬프트 분류 (benign / harmful / jailbreak) | jailbreak 86,512 (+ benign 64,979 · harmful 26,480) | 숭실대 · 이로운앤컴퍼니 (Park et al.) | 정보보호학회논문지 2025 | ❓ (데이터 공개 미확인) | [논문](https://koreascience.or.kr/article/JAKO202518939602628.page) |
...
| [KSAFE-MM](https://arxiv.org/abs/2605.28013) | 한국 문화 특화 MLLM 안전성 (jailbreak · cross-modal 공격) | 14,135 samples (G: 번역 / C: 한국 특화) | Yongwoo Kim et al. | arXiv 2026.05 | ❓ (확인 필요) | [arXiv](https://arxiv.org/abs/2605.28013) |
